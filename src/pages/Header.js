...
const Header = () => {
  ...
  return (
    <header
      className="flex justify-center w-full h-16   bg-slate-800"
      action="submit"
    >
      <div className="flex relative justify-center items-center rounded-md w-full md:w-8/12 px-8   h-16 bg-slate-400">
        <div className="flex left-4 absolute md:left-8">
          <label htmlFor="todo" className="hidden xl:block" >
            order by:
          </label>
          ...
          <select
            ...
            name="todo"
            id="todo"
            className=" bg-transparent outline-none w-8 border-2 rounded-lg xs:w-12 sm:w-16 md:w-16 lg:w-36"
          >
        ...
        <div className="">
          <p>Welcome to your Todos List</p>
        </div>
      </div>
    </header>
  );
